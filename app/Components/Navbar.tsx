        ...
        <main>
            <nav className="bg-photkarimblue">
                <div className="
                    ...
                    lg:flex lg:flex-row lg:space-x-11 lg:items-center lg:justify-center
                ">
                    <Link className="heroTextColor" href="/">Home</Link><br />
                    <Link className="hover:bg-gray-500 hover:text-blue-600" href="/Carriere">Carrière</Link><br />
                    <Link className="hover:bg-gray-500 hover:text-blue-600" href="/Projets">Projets</Link>
                </div>
            </nav>
        </main>
